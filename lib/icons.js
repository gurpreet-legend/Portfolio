...
{
    name: 'Vite',
    icon: () => <TechLogo src={viteLogoSrc} width="4em"/>,
    config: {
        color: '#0984e3',
        size:'4em'
    },
...
{
    name: 'Figma',
    icon: () => <TechLogo src={figmaLogoSrc} width="2.5em"/>,
    config: {
        color: '#0984e3',
        size:'4em'
    },
...
{
    name: 'Web3.js',
    icon: () => <TechLogo src={web3jsLogoSrc} width="4em"/>,
    config: {
        color: '#ffffff',
        size:'4em'
    },
...
{
    name: 'Ganache',
    icon: () => <TechLogo src={ganacheLogoSrc} width="4em"/>,
    config: {
        color: '#ffffff',
        size:'4em'
    },
...
{
    name: 'Truffle',
    icon: () => <TechLogo src={truffleLogoSrc} width="4em"/>,
    config: {
        color: '#ffffff',
        size:'4em'
    },
